...
</br>Благодаря DI, классы не жестко связаны между собой, а зависят от абстракций, которые могут быть реализованы различными способами. Это позволяет легко заменять реализации абстракций, не изменяя код классов, которые от них зависят. 
